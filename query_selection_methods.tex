...
We consider three ways of selecting a query set for which we generate responses for each new model, using the query-model energy tensor $E \in \mathbb{R}^{\binom{n}{2} \times M}$.
