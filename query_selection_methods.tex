...
The discriminative factorization estimates per-query signal magnitudes $|\hat{\alpha}_{q,\ell}|$ from the pilot set.
We describe three strategies for using this information to select $Q^*$.
