...
We consider three ways of selecting a query set for which we generate responses for each new model, using the query-model energy tensor $E \in \mathbb{R}^{M \times \binom{n}{2}}$.
...
Fit a two-component GMM to the estimated field strengths $|\hat{\alpha}_{q,\ell}|$ obtained from the SVD of $E$.
